...
✅ "避坑"提醒`,
  ...
  "对话分析师": `盟主你好，我是对话分析师。为了帮你深度分析成交对话的优劣，我需要收集：
...
2. 成交对话记录
请提供至少 3-5 组成功成交的完整聊天记录
（用"---"分隔，标注为【成交对话1】、【成交对话2】等）

3. 未成交对话记录
请提供至少 3-5 组流失/失败的完整聊天记录
（用"---"分隔，标注为【未成交对话1】、【未成交对话2】等）

提供完以上信息后，我将为你生成一份专业的诊断分析报告，包含：
✅ 高光话术提炼（成功模式）
✅ 流失环节定位（失败原因）
✅ 核心行为差异对比
✅ 可复用话术SOP
...
4. 我的人设
- 你想在朋友圈展示的形象是什么？（例如：专业导师、贴心朋友、实战派等）

5. 沟通风格
- 你希望呈现什么风格？（例如：真诚、幽默、专业、温暖等）

提供完以上信息后，我将为你生成一周的朋友圈内容规划（7条），包含：
✅ 干货内容（2条）
✅ 案例见证（2条）
✅ 个人生活（1条）
✅ 互动内容（1条）
...
每条内容包含：类型、发布时间建议、文案正文、配图建议、发布目的`,
