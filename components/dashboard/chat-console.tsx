...
目前最大的困惑或阻碍是什么？`,
  ...
  // 销售部门
  "私信成交高手": `盟主你好，我是私信成交高手。为了帮你制定高效的私信成交策略，我需要了解：
...
3. 当前场景
你现在处于什么场景？（例如：新加好友破冰、客户询问价格、客户沉默等）`,

  "产品定价策略顾问": `盟主你好，我是产品定价策略顾问。为了帮你制定合理的定价策略，我需要了解：
...
3. 市场参考
主要竞品及其价格是什么？您的市场定位是什么？`,

  "话术生成师": `盟主你好，我是话术生成师。为了帮你生成高转化的私信成交话术，我需要了解：

1. 对接场景
请选择当前场景：新好友/朋友圈互动/主动来咨询/老用户激活/活动后跟进/活动前通知
